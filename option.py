...
parser.add_argument("--nEpochs", type=int, default=80, help="maximum number of epochs to train")
...
# Test image
parser.add_argument('--model_name', default='/home/yanglz/Test_SFCSR/Coda/SFCSR-master/checkpoint_ssb4/model_2_epoch_29.pth', type=str, help='super resolution model name ')
parser.add_argument('--method', default='SFCSRssb', type=str, help='super resolution method name')
